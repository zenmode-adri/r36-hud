 ...
 * Hook: SDL_GL_SwapWindow + eglSwapBuffers via LD_PRELOAD
 * Config: /home/ark/.config/r36overlay.conf
 * Compile (on-device):
 *   gcc -shared -fPIC -O2 -o libr36overlay.so r36_overlay.c -ldl -lGLESv2
 */
#define _GNU_SOURCE
#include <dlfcn.h>
#include <stdio.h>
...
/* ------------------------------------------------------------------ */
/* 8x8 bitmap font, public domain (derived from linux/lib/fonts)      */
/* bit order: bit0 (LSB) = leftmost pixel                             */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* 8x16 VGA-style bitmap font (bit7=leftmost pixel per row)           */
/* ------------------------------------------------------------------ */
...
/* 23 # */{0x00,0x00,0x00,0x36,0x36,0x7F,0x36,0x36,0x36,0x7F,0x36,0x36,0x00,0x00,0x00,0x00},
/* 24 $ */{0x18,0x18,0x7E,0x03,0x03,0x1E,0x18,0x30,0x30,0x3F,0x18,0x18,0x00,0x00,0x00,0x00},
/* 25 % */{0x00,0x00,0x00,0x23,0x33,0x18,0x0C,0x06,0x33,0x31,0x00,0x00,0x00,0x00,0x00,0x00},
/* 26 & */{0x00,0x00,0x0E,0x1B,0x1B,0x0E,0x6E,0x7B,0x33,0x33,0x33,0x6E,0x00,0x00,0x00,0x00},
/* 27 ' */{0x00,0x0C,0x0C,0x0C,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/* 28 ( */{0x00,0x00,0x18,0x0C,0x06,0x06,0x06,0x06,0x06,0x06,0x0C,0x18,0x00,0x00,0x00,0x00},
/* 29 ) */{0x00,0x00,0x06,0x0C,0x18,0x18,0x18,0x18,0x18,0x18,0x0C,0x06,0x00,0x00,0x00,0x00},
/* 2A * */{0x00,0x00,0x00,0x00,0x00,0x63,0x36,0x1C,0x36,0x63,0x00,0x00,0x00,0x00,0x00,0x00},
/* 2B + */{0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x7E,0x18,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
/* 2C , */{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x18,0x18,0x18,0x0C,0x00,0x00,0x00},
...
/* 2F / */{0x00,0x00,0x00,0x40,0x60,0x30,0x18,0x0C,0x06,0x03,0x01,0x00,0x00,0x00,0x00,0x00},
/* 30 0 */{0x00,0x00,0x3C,0x66,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 31 1 */{0x00,0x00,0x18,0x1C,0x1E,0x18,0x18,0x18,0x18,0x18,0x18,0x7E,0x00,0x00,0x00,0x00},
/* 32 2 */{0x00,0x00,0x3E,0x63,0xC3,0xC0,0x60,0x30,0x18,0x0C,0x63,0xFF,0x00,0x00,0x00,0x00},
/* 33 3 */{0x00,0x00,0x7E,0xC3,0xC0,0xC0,0x7C,0xC0,0xC0,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 34 4 */{0x00,0x00,0x60,0x70,0x78,0x6C,0x66,0xFF,0x60,0x60,0x60,0xF0,0x00,0x00,0x00,0x00},
/* 35 5 */{0x00,0x00,0xFF,0x03,0x03,0x03,0x7F,0xC0,0xC0,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 36 6 */{0x00,0x00,0x7C,0x06,0x03,0x03,0x7F,0xC3,0xC3,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 37 7 */{0x00,0x00,0xFF,0xC3,0xC0,0x60,0x30,0x18,0x0C,0x0C,0x0C,0x0C,0x00,0x00,0x00,0x00},
/* 38 8 */{0x00,0x00,0x3C,0x66,0xC3,0xC3,0x66,0x3C,0x66,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 39 9 */{0x00,0x00,0x3C,0x66,0xC3,0xC3,0xFE,0xC0,0xC0,0xC0,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 3A : */{0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x00,0x00,0x00},
/* 3B ; */{0x00,0x00,0x00,0x00,0x18,0x18,0x00,0x00,0x18,0x18,0x18,0x0C,0x00,0x00,0x00,0x00},
/* 3C < */{0x00,0x00,0x00,0x60,0x30,0x18,0x0C,0x06,0x0C,0x18,0x30,0x60,0x00,0x00,0x00,0x00},
/* 3D = */{0x00,0x00,0x00,0x00,0x00,0x7E,0x00,0x00,0x7E,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/* 3E > */{0x00,0x00,0x00,0x06,0x0C,0x18,0x30,0x60,0x30,0x18,0x0C,0x06,0x00,0x00,0x00,0x00},
/* 3F ? */{0x00,0x00,0x3C,0x66,0xC3,0xC0,0x60,0x30,0x18,0x00,0x18,0x18,0x00,0x00,0x00,0x00},
/* 40 @ */{0x00,0x00,0x3C,0x66,0x7B,0xDB,0xDB,0xDB,0x7B,0x06,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 41 A */{0x00,0x00,0x18,0x3C,0x66,0xC3,0xC3,0xFF,0xC3,0xC3,0xC3,0xC3,0x00,0x00,0x00,0x00},
/* 42 B */{0x00,0x00,0x3F,0x66,0x66,0x66,0x3E,0x66,0x66,0x66,0x66,0x3F,0x00,0x00,0x00,0x00},
/* 43 C */{0x00,0x00,0x7C,0xC6,0x83,0x03,0x03,0x03,0x03,0x83,0xC6,0x7C,0x00,0x00,0x00,0x00},
/* 44 D */{0x00,0x00,0x3F,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x3F,0x00,0x00,0x00,0x00},
/* 45 E */{0x00,0x00,0xFF,0x66,0x46,0x06,0x1E,0x06,0x06,0x46,0x66,0xFF,0x00,0x00,0x00,0x00},
/* 46 F */{0x00,0x00,0xFF,0x66,0x46,0x06,0x1E,0x06,0x06,0x06,0x06,0x0F,0x00,0x00,0x00,0x00},
/* 47 G */{0x00,0x00,0x7C,0xC6,0x83,0x03,0x03,0xF3,0xC3,0xC3,0xC6,0x7C,0x00,0x00,0x00,0x00},
/* 48 H */{0x00,0x00,0xC3,0xC3,0xC3,0xC3,0xFF,0xC3,0xC3,0xC3,0xC3,0xC3,0x00,0x00,0x00,0x00},
/* 49 I */{0x00,0x00,0x3C,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
/* 4A J */{0x00,0x00,0x78,0x30,0x30,0x30,0x30,0x30,0x33,0x33,0x33,0x1E,0x00,0x00,0x00,0x00},
/* 4B K */{0x00,0x00,0xC3,0x63,0x33,0x1B,0x0F,0x0F,0x1B,0x33,0x63,0xC3,0x00,0x00,0x00,0x00},
/* 4C L */{0x00,0x00,0x0F,0x06,0x06,0x06,0x06,0x06,0x06,0x46,0x66,0xFF,0x00,0x00,0x00,0x00},
/* 4D M */{0x00,0x00,0xC3,0xE7,0xFF,0xDB,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0x00,0x00,0x00,0x00},
/* 4E N */{0x00,0x00,0xC3,0xC7,0xCF,0xDB,0xF3,0xE3,0xC3,0xC3,0xC3,0xC3,0x00,0x00,0x00,0x00},
/* 4F O */{0x00,0x00,0x3C,0x66,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 50 P */{0x00,0x00,0x3F,0x66,0x66,0x66,0x3E,0x06,0x06,0x06,0x06,0x0F,0x00,0x00,0x00,0x00},
/* 51 Q */{0x00,0x00,0x3C,0x66,0xC3,0xC3,0xC3,0xC3,0xDB,0xCB,0x66,0x3C,0x60,0x00,0x00,0x00},
/* 52 R */{0x00,0x00,0x3F,0x66,0x66,0x66,0x3E,0x1E,0x36,0x66,0x66,0x67,0x00,0x00,0x00,0x00},
/* 53 S */{0x00,0x00,0x7C,0xC6,0x83,0x03,0x3E,0x78,0xC0,0xC1,0x63,0x3E,0x00,0x00,0x00,0x00},
/* 54 T */{0x00,0x00,0xFF,0xDB,0x99,0x18,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
/* 55 U */{0x00,0x00,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 56 V */{0x00,0x00,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0xC3,0x66,0x3C,0x18,0x00,0x00,0x00,0x00},
/* 57 W */{0x00,0x00,0xC3,0xC3,0xC3,0xC3,0xDB,0xDB,0xFF,0x66,0x66,0x66,0x00,0x00,0x00,0x00},
/* 58 X */{0x00,0x00,0xC3,0x66,0x66,0x3C,0x18,0x18,0x3C,0x66,0x66,0xC3,0x00,0x00,0x00,0x00},
/* 59 Y */{0x00,0x00,0xC3,0xC3,0x66,0x66,0x3C,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
/* 5A Z */{0x00,0x00,0xFF,0xC3,0xE1,0x70,0x38,0x1C,0x0E,0x87,0xC3,0xFF,0x00,0x00,0x00,0x00},
/* 5B [ */{0x00,0x00,0x3C,0x0C,0x0C,0x0C,0x0C,0x0C,0x0C,0x0C,0x0C,0x3C,0x00,0x00,0x00,0x00},
/* 5C \ */{0x00,0x00,0x00,0x01,0x03,0x06,0x0C,0x18,0x30,0x60,0x40,0x00,0x00,0x00,0x00,0x00},
/* 5D ] */{0x00,0x00,0x3C,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x3C,0x00,0x00,0x00,0x00},
/* 5E ^ */{0x00,0x10,0x38,0x6C,0xC6,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/* 5F _ */{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0xFF,0x00,0x00,0x00,0x00},
/* 60 ` */{0x00,0x0C,0x0C,0x18,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/* 61 a */{0x00,0x00,0x00,0x00,0x00,0x3E,0x60,0x60,0x7E,0x63,0x63,0x7E,0x00,0x00,0x00,0x00},
/* 62 b */{0x00,0x00,0x07,0x06,0x06,0x36,0x66,0x66,0x66,0x66,0x36,0x1F,0x00,0x00,0x00,0x00},
/* 63 c */{0x00,0x00,0x00,0x00,0x00,0x7C,0xC6,0x03,0x03,0x03,0xC6,0x7C,0x00,0x00,0x00,0x00},
/* 64 d */{0x00,0x00,0x70,0x60,0x60,0x7C,0x66,0x66,0x66,0x66,0x6C,0x78,0x00,0x00,0x00,0x00},
/* 65 e */{0x00,0x00,0x00,0x00,0x00,0x3C,0x66,0xC3,0xFF,0x03,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 66 f */{0x00,0x00,0x38,0x0C,0x06,0x06,0x3F,0x06,0x06,0x06,0x06,0x0F,0x00,0x00,0x00,0x00},
/* 67 g */{0x00,0x00,0x00,0x00,0x00,0x7C,0x66,0x66,0x66,0x66,0x66,0x7C,0x60,0x63,0x3E,0x00},
/* 68 h */{0x00,0x00,0x07,0x06,0x06,0x36,0x6E,0x66,0x66,0x66,0x66,0x67,0x00,0x00,0x00,0x00},
/* 69 i */{0x00,0x00,0x18,0x18,0x00,0x1C,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
/* 6A j */{0x00,0x00,0x30,0x30,0x00,0x3C,0x30,0x30,0x30,0x30,0x30,0x33,0x33,0x1E,0x00,0x00},
/* 6B k */{0x00,0x00,0x07,0x06,0x06,0x66,0x36,0x1E,0x1E,0x36,0x66,0x67,0x00,0x00,0x00,0x00},
/* 6C l */{0x00,0x00,0x1C,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x3C,0x00,0x00,0x00,0x00},
/* 6D m */{0x00,0x00,0x00,0x00,0x00,0x6B,0xFF,0xDB,0xDB,0xDB,0xDB,0xDB,0x00,0x00,0x00,0x00},
/* 6E n */{0x00,0x00,0x00,0x00,0x00,0x3B,0x66,0x66,0x66,0x66,0x66,0x66,0x00,0x00,0x00,0x00},
/* 6F o */{0x00,0x00,0x00,0x00,0x00,0x3C,0x66,0xC3,0xC3,0xC3,0x66,0x3C,0x00,0x00,0x00,0x00},
/* 70 p */{0x00,0x00,0x00,0x00,0x00,0x1F,0x36,0x66,0x66,0x66,0x36,0x1E,0x06,0x06,0x0F,0x00},
/* 71 q */{0x00,0x00,0x00,0x00,0x00,0x7C,0x66,0x66,0x66,0x66,0x6C,0x78,0x60,0x60,0x70,0x00},
/* 72 r */{0x00,0x00,0x00,0x00,0x00,0x37,0x6E,0x06,0x06,0x06,0x06,0x0F,0x00,0x00,0x00,0x00},
/* 73 s */{0x00,0x00,0x00,0x00,0x00,0x7E,0xC3,0x03,0x3C,0x60,0xC3,0x7E,0x00,0x00,0x00,0x00},
/* 74 t */{0x00,0x00,0x00,0x0C,0x0C,0x3F,0x0C,0x0C,0x0C,0x0C,0xCC,0x78,0x00,0x00,0x00,0x00},
/* 75 u */{0x00,0x00,0x00,0x00,0x00,0x63,0x63,0x63,0x63,0x63,0x63,0x7E,0x00,0x00,0x00,0x00},
/* 76 v */{0x00,0x00,0x00,0x00,0x00,0x63,0x63,0x63,0x63,0x63,0x36,0x1C,0x00,0x00,0x00,0x00},
/* 77 w */{0x00,0x00,0x00,0x00,0x00,0xC3,0xC3,0xC3,0xDB,0xDB,0xFF,0x66,0x00,0x00,0x00,0x00},
/* 78 x */{0x00,0x00,0x00,0x00,0x00,0xC3,0x66,0x3C,0x18,0x3C,0x66,0xC3,0x00,0x00,0x00,0x00},
/* 79 y */{0x00,0x00,0x00,0x00,0x00,0x63,0x63,0x63,0x63,0x63,0x3E,0x60,0x63,0x3E,0x00,0x00},
/* 7A z */{0x00,0x00,0x00,0x00,0x00,0xFF,0xC1,0x60,0x30,0x18,0x83,0xFF,0x00,0x00,0x00,0x00},
/* 7B { */{0x00,0x00,0x70,0x18,0x18,0x18,0x0E,0x18,0x18,0x18,0x18,0x70,0x00,0x00,0x00,0x00},
/* 7C | */{0x00,0x18,0x18,0x18,0x18,0x18,0x00,0x18,0x18,0x18,0x18,0x18,0x00,0x00,0x00,0x00},
/* 7D } */{0x00,0x00,0x0E,0x18,0x18,0x18,0x70,0x18,0x18,0x18,0x18,0x0E,0x00,0x00,0x00,0x00},
/* 7E ~ */{0x00,0x00,0x00,0x00,0x6E,0x3B,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
/* 7F   */{0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF},
};
...
/* ------------------------------------------------------------------ */
/* Config (read from /home/ark/.config/r36overlay.conf)               */
/* ------------------------------------------------------------------ */
#define CONFIG_PATH "/home/ark/.config/r36overlay.conf"
static int cfg_show_fps       = 1;
static int cfg_show_cpu_temp  = 1;
static int cfg_show_cpu_mhz   = 1;
static int cfg_show_gpu_mhz   = 1;
static int cfg_show_ram_mhz   = 1;
static int cfg_show_ram_pct   = 0;
static int cfg_show_vdd_arm   = 0;
static int cfg_show_vdd_logic = 0;
static int cfg_show_bat       = 1;
static int cfg_corner         = 0; /* 0=TL 1=TR 2=BL 3=BR */
static int cfg_scale          = 1; /* 1 or 2 */
static int cfg_font           = 0; /* 0=8x8 (default), 1=8x16 */
...
static void load_config(void) {
    ...
    while (fgets(line, sizeof(line), f)) {
        ...
        int v = atoi(val);
        if (!strcmp(key,"show_fps"))       cfg_show_fps       = v;
        if (!strcmp(key,"show_cpu_temp"))  cfg_show_cpu_temp  = v;
        if (!strcmp(key,"show_cpu_mhz"))   cfg_show_cpu_mhz   = v;
        if (!strcmp(key,"show_gpu_mhz"))   cfg_show_gpu_mhz   = v;
        if (!strcmp(key,"show_ram_mhz"))   cfg_show_ram_mhz   = v;
        if (!strcmp(key,"show_ram_pct"))   cfg_show_ram_pct   = v;
        if (!strcmp(key,"show_vdd_arm"))   cfg_show_vdd_arm   = v;
        if (!strcmp(key,"show_vdd_logic")) cfg_show_vdd_logic = v;
        if (!strcmp(key,"show_bat"))       cfg_show_bat       = v;
        if (!strcmp(key,"corner"))         cfg_corner         = (v>=0&&v<=3)?v:0;
        if (!strcmp(key,"scale"))          cfg_scale          = (v==2)?2:1;
        if (!strcmp(key,"font"))           cfg_font           = (v==1)?1:0;
    }
    fclose(f);
}
...
#define OH 120   /* overlay pixel height (enough for 8x16 at 1x: 6*18+4=112) */
...
static int     bat_ma       = 0;   /* + charging, - draining */
static int     bat_mw       = 0;   /* |V*I| in mW            */
static int     bat_charging = 0;   /* 1=charging/full, 0=draining */
...
static void update_stats(void) {
    ...
    bat_pct = sysfs_int("/sys/class/power_supply/battery/capacity");
    {
        int uv  = sysfs_int("/sys/class/power_supply/battery/voltage_now"); /* uV */
        int ua  = sysfs_int("/sys/class/power_supply/battery/current_now"); /* uA */
        bat_ma  = ua / 1000;
        bat_mw  = (int)((long long)(uv / 1000) * (ua < 0 ? -ua : ua) / 1000000LL);
        bat_charging = (ua >= 0);
    }
}
...
static void render_overlay(void) {
    tex_dirty = 1;
    memset(obuf, 0, OW * OH * 4);

    /* line height: char_h*scale + gap */
    int ch = (cfg_font == 1) ? 16 : 8;
    const int LH = ch * cfg_scale + (cfg_scale == 2 ? 4 : 2);
    char buf[32];
    int y = 2;
    int n_lines = 0;

    if (cfg_show_fps)       n_lines++;
    if (cfg_show_cpu_temp || cfg_show_cpu_mhz) n_lines++;
    if (cfg_show_gpu_mhz)   n_lines++;
    if (cfg_show_ram_mhz || cfg_show_ram_pct) n_lines++;
    if (cfg_show_vdd_arm || cfg_show_vdd_logic) n_lines++;
    if (cfg_show_bat)       n_lines++;

    if (n_lines == 0) return;

    int used_h = n_lines * LH + 4;
    if (used_h > OH) used_h = OH;
    fill_rect(0, 0, OW, used_h, 0, 0, 0, 160);

    if (cfg_show_fps) {
        snprintf(buf, sizeof(buf), "FPS %d", (int)(current_fps + 0.5));
        draw_str(2, y, buf, cfg_scale, 255, 255, 0);
        y += LH;
    }
    if (cfg_show_cpu_temp || cfg_show_cpu_mhz) {
        if (cfg_show_cpu_temp && cfg_show_cpu_mhz)
            snprintf(buf, sizeof(buf), "CPU %dC %dMHz", cpu_temp_c, cpu_mhz);
        else if (cfg_show_cpu_temp)
            snprintf(buf, sizeof(buf), "CPU %dC", cpu_temp_c);
        else
            snprintf(buf, sizeof(buf), "CPU %dMHz", cpu_mhz);
        draw_str(2, y, buf, cfg_scale, 0, 255, 128);
        y += LH;
    }
    if (cfg_show_gpu_mhz) {
        snprintf(buf, sizeof(buf), "GPU %dMHz", gpu_mhz);
        draw_str(2, y, buf, cfg_scale, 0, 200, 255);
        y += LH;
    }
    if (cfg_show_ram_mhz || cfg_show_ram_pct) {
        if (cfg_show_ram_mhz && cfg_show_ram_pct)
            snprintf(buf, sizeof(buf), "RAM %dMHz %d%%", ram_mhz, ram_pct);
        else if (cfg_show_ram_mhz)
            snprintf(buf, sizeof(buf), "RAM %dMHz", ram_mhz);
        else
            snprintf(buf, sizeof(buf), "RAM %d%%", ram_pct);
        draw_str(2, y, buf, cfg_scale, 200, 150, 255);
        y += LH;
    }
    if (cfg_show_vdd_arm || cfg_show_vdd_logic) {
        if (cfg_show_vdd_arm && cfg_show_vdd_logic)
            snprintf(buf, sizeof(buf), "CPU %d G/R %dmV", vdd_arm_mv, vdd_logic_mv);
        else if (cfg_show_vdd_arm)
            snprintf(buf, sizeof(buf), "CPU %dmV", vdd_arm_mv);
        else
            snprintf(buf, sizeof(buf), "G/R %dmV", vdd_logic_mv);
        draw_str(2, y, buf, cfg_scale, 255, 180, 80);
        y += LH;
    }
    if (cfg_show_bat) {
        if (bat_charging) {
            if (bat_ma >= 1000)
                snprintf(buf, sizeof(buf), "BAT %d%% +%.1fA", bat_pct, bat_ma / 1000.0f);
            else
                snprintf(buf, sizeof(buf), "BAT %d%% +%dmA", bat_pct, bat_ma);
        } else {
            snprintf(buf, sizeof(buf), "BAT %d%% -%.1fW", bat_pct, bat_mw / 1000.0f);
        }
        uint8_t br = bat_charging ? 80  : (bat_pct < 20 ? 255 : bat_pct < 50 ? 255 : 100);
        uint8_t bg = bat_charging ? 220 : (bat_pct < 20 ?  60 : bat_pct < 50 ? 200 : 255);
        uint8_t bb = bat_charging ? 100 : 80;
        draw_str(2, y, buf, cfg_scale, br, bg, bb);
    }
}
...
static void init_gl(void *gles) {
    ...
    /* VBO allocated empty — vertices computed per-frame in draw_overlay()
       so position is correct for any resolution and corner config. */
    _glGenBuffers(1, &ovbo);
    _glBindBuffer(GL_ARRAY_BUFFER, ovbo);
    _glBufferData(GL_ARRAY_BUFFER, 6 * 4 * sizeof(float), NULL, GL_DYNAMIC_DRAW);
...
static void draw_overlay(void) {
    ...
    /* update quad vertices for current viewport + corner config */
    {
        float sw = (float)vp[2], sh = (float)vp[3];
        int ow_px = OW * cfg_scale, oh_px = OH * cfg_scale;
        float ndcW = 2.0f * ow_px / sw;
        float ndcH = 2.0f * oh_px / sh;
        float x1, y1, x2, y2;
        switch (cfg_corner) {
            case 1: x1=1.0f-ndcW; y1= 1.0f; x2=1.0f;     y2= 1.0f-ndcH; break; /* TR */
            case 2: x1=-1.0f;     y1=-1.0f+ndcH; x2=-1.0f+ndcW; y2=-1.0f; break; /* BL */
            case 3: x1=1.0f-ndcW; y1=-1.0f+ndcH; x2=1.0f; y2=-1.0f;       break; /* BR */
            default:x1=-1.0f;     y1= 1.0f; x2=-1.0f+ndcW; y2= 1.0f-ndcH; break; /* TL */
        }
        float verts[] = {
            x1,y1, 0.0f,0.0f,
            x2,y1, 1.0f,0.0f,
